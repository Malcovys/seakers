...
/// generated route for
/// [_i5.ItemDetailPage]
class ItemDetailRoute extends _i9.PageRouteInfo<void> {
  const ItemDetailRoute({List<_i9.PageRouteInfo>? children})
  ...
  static _i9.PageInfo page = _i9.PageInfo(
    name,
    builder: (data) {
      return const _i5.ItemDetailPage();
    },
  );
}
...
class PurchaseItemsRoute extends _i9.PageRouteInfo<void> {
  const PurchaseItemsRoute({List<_i9.PageRouteInfo>? children})
    : super(PurchaseItemsRoute.name, initialChildren: children);
  ...
  static _i9.PageInfo page = _i9.PageInfo(
    name,
    builder: (data) {
      return const _i8.PurchaseItemsPage();
    },
  );
}
